...
class LocationNode:
    ...
    Fields:
        _loc (L):
            Object of any orderable type representing the location value.
        
        _dim (int):
            An integer representing the dimension value.
        
        _dim_label (str):
            A string further representing the dimension for cases in which it is 
            indicative of something other than a number. (Only used for printing
            purposes.)  """
    ...
    def __init__(self, location:L, dimension:int, 
        ...
        Args:
            location (L): 
                Object of any sortable type representing the location of this
                LocationNode.
            
            dimension (int): 
                Dimension value of this LocationNode.
    ...
    def set_loc(self, loc:L) -> None:
        """        
        Arg -> loc (L): A location variable of any orderable type to be set as 
            the location value of this node.    """
        self._loc = loc
